...
userRouter.get("/search", checkTokens, roleGuard("admin", "superAdmin"), pagination, searchUser);
userRouter.get("/user/:id",checkTokens, isSelfRoleGuard("admin", "superAdmin"), getUserById);
userRouter.put("/user/:id", checkTokens, isSelfRoleGuard("admin", "superAdmin"), updateUserById);
